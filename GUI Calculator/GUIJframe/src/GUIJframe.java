...
public class GUIJframe extends javax.swing.JFrame {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        String InputNumber = jTextField1.getText() + jButton5.getText();
        jTextField1.setText(InputNumber);
    }                                        

    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        String InputNumber = jTextField1.getText() + jButton9.getText();
        jTextField1.setText(InputNumber);
    }                                        

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        String InputNumber = jTextField1.getText() + jButton1.getText();
        jTextField1.setText(InputNumber);
    }                                        

    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {                                          
        String InputNumber = jTextField1.getText() + jButton15.getText();
        jTextField1.setText(InputNumber);
    }                                         
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        String InputNumber = jTextField1.getText() + jButton8.getText();
        jTextField1.setText(InputNumber);
    }                                        
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        String InputNumber = jTextField1.getText() + jButton2.getText();
        jTextField1.setText(InputNumber);
    }                                        

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        String InputNumber = jTextField1.getText() + jButton3.getText();
        jTextField1.setText(InputNumber);
    }                                        

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        String InputNumber = jTextField1.getText() + jButton4.getText();
        jTextField1.setText(InputNumber);
    }                                        

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        String InputNumber = jTextField1.getText() + jButton6.getText();
        jTextField1.setText(InputNumber);
    }                                        

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        String InputNumber = jTextField1.getText() + jButton7.getText();
        jTextField1.setText(InputNumber);
    }                                        

    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {                                          
        String InputNumber = jTextField1.getText() + jButton18.getText();
        jTextField1.setText(InputNumber);
    }                                         
